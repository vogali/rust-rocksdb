...
// instead...
extern "C" {
    pub fn crocksdb_get_options_cf(db: *mut DBInstance, cf: *mut DBCFHandle) -> *mut DBOption;
    pub fn crocksdb_options_create() -> *mut DBOption;
    pub fn crocksdb_options_copy(opts: *const DBOption) -> *mut DBOption;
    pub fn crocksdb_options_destroy(opts: *mut DBOption);
    ...
    pub fn crocksdb_options_set_block_based_table_factory(
        options: *mut DBOption,
        block_options: *mut DBBlockBasedTableOptions);
    pub fn crocksdb_block_based_options_set_pin_l0_filter_and_index_blocks_in_cache(
        block_options: *mut DBBlockBasedTableOptions, v: c_uchar);
    pub fn crocksdb_options_increase_parallelism(options: *mut DBOption, threads: c_int);
    pub fn crocksdb_options_optimize_level_style_compaction(options: *mut DBOption,
                                                            memtable_memory_budget: c_int);
    pub fn crocksdb_options_set_compaction_filter(options: *mut DBOption,
                                                  filter: *mut DBCompactionFilter);
    pub fn crocksdb_options_set_create_if_missing(options: *mut DBOption, v: bool);
    pub fn crocksdb_options_set_max_open_files(options: *mut DBOption, files: c_int);
    pub fn crocksdb_options_set_max_total_wal_size(options: *mut DBOption, size: u64);
    pub fn crocksdb_options_set_use_fsync(options: *mut DBOption, v: c_int);
    pub fn crocksdb_options_set_bytes_per_sync(options: *mut DBOption, bytes: u64);
    pub fn crocksdb_options_set_enable_pipelined_write(options: *mut DBOption, v: bool);
    pub fn crocksdb_options_set_allow_concurrent_memtable_write(options: *mut DBOption, v: bool);
    pub fn crocksdb_options_optimize_for_point_lookup(options: *mut DBOption,
                                                      block_cache_size_mb: u64);
    pub fn crocksdb_options_set_table_cache_numshardbits(options: *mut DBOption, bits: c_int);
    pub fn crocksdb_options_set_writable_file_max_buffer_size(options: *mut DBOption,
                                                              nbytes: c_int);
    pub fn crocksdb_options_set_max_write_buffer_number(options: *mut DBOption, bufno: c_int);
    pub fn crocksdb_options_set_min_write_buffer_number_to_merge(options: *mut DBOption,
                                                                 bufno: c_int);
    pub fn crocksdb_options_set_level0_file_num_compaction_trigger(options: *mut DBOption,
                                                                   no: c_int);
    pub fn crocksdb_options_set_level0_slowdown_writes_trigger(options: *mut DBOption, no: c_int);
    pub fn crocksdb_options_set_level0_stop_writes_trigger(options: *mut DBOption, no: c_int);
    pub fn crocksdb_options_set_write_buffer_size(options: *mut DBOption, bytes: u64);
    pub fn crocksdb_options_set_target_file_size_base(options: *mut DBOption, bytes: u64);
    pub fn crocksdb_options_set_target_file_size_multiplier(options: *mut DBOption, mul: c_int);
    pub fn crocksdb_options_set_max_bytes_for_level_base(options: *mut DBOption, bytes: u64);
    pub fn crocksdb_options_set_max_bytes_for_level_multiplier(options: *mut DBOption,
                                                               mul: c_int);
    pub fn crocksdb_options_set_max_compaction_bytes(options: *mut DBOption, bytes: uint64_t);
    pub fn crocksdb_options_set_max_log_file_size(options: *mut DBOption, bytes: size_t);
    pub fn crocksdb_options_set_log_file_time_to_roll(options: *mut DBOption, bytes: size_t);
    pub fn crocksdb_options_set_info_log_level(options: *mut DBOption, level: DBInfoLogLevel);
    pub fn crocksdb_options_set_keep_log_file_num(options: *mut DBOption, num: size_t);
    pub fn crocksdb_options_set_max_manifest_file_size(options: *mut DBOption, bytes: u64);
    pub fn crocksdb_options_set_hash_skip_list_rep(options: *mut DBOption,
                                                   bytes: u64,
                                                   a1: i32,
                                                   a2: i32);
    pub fn crocksdb_options_set_compaction_style(options: *mut DBOption, cs: DBCompactionStyle);
    pub fn crocksdb_options_set_compression(options: *mut DBOption,
                                            compression_style_no: DBCompressionType);
    pub fn crocksdb_options_get_compression(options: *mut DBOption) -> DBCompressionType;
    pub fn crocksdb_options_set_compression_per_level(options: *mut DBOption,
                                                      level_values: *const DBCompressionType,
                                                      num_levels: size_t);
    pub fn crocksdb_options_get_compression_level_number(options: *mut DBOption) -> size_t;
    pub fn crocksdb_options_get_compression_per_level(options: *mut DBOption,
                                                      level_values: *mut DBCompressionType);
    pub fn crocksdb_set_bottommost_compression(options: *mut DBOption, c: DBCompressionType);
    pub fn crocksdb_options_set_base_background_compactions(optinos: *mut DBOption,
                                                            base_bg_compactions: c_int);
    pub fn crocksdb_options_set_max_background_compactions(options: *mut DBOption,
                                                           max_bg_compactions: c_int);
    pub fn crocksdb_options_set_max_background_flushes(options: *mut DBOption,
                                                       max_bg_flushes: c_int);
    pub fn crocksdb_options_set_disable_auto_compactions(options: *mut DBOption, v: c_int);
    pub fn crocksdb_options_set_report_bg_io_stats(options: *mut DBOption, v: c_int);
    pub fn crocksdb_options_set_compaction_readahead_size(options: *mut DBOption, v: size_t);
    pub fn crocksdb_options_set_wal_recovery_mode(options: *mut DBOption, mode: DBRecoveryMode);
    pub fn crocksdb_options_set_max_subcompactions(options: *mut DBOption, v: u32);
    pub fn crocksdb_options_set_wal_bytes_per_sync(options: *mut DBOption, v: u64);
    pub fn crocksdb_options_enable_statistics(options: *mut DBOption);
    pub fn crocksdb_options_statistics_get_string(options: *mut DBOption) -> *const c_char;
    pub fn crocksdb_options_statistics_get_ticker_count(options: *mut DBOption,
                                                        ticker_type: DBStatisticsTickerType)
                                                        -> u64;
    pub fn crocksdb_options_statistics_get_and_reset_ticker_count(options: *mut DBOption,
                                                        ticker_type: DBStatisticsTickerType)
                                                        -> u64;
    pub fn crocksdb_options_statistics_get_histogram_string(options: *mut DBOption,
                                                            hist_type: DBStatisticsHistogramType)
                                                            -> *const c_char;
    pub fn crocksdb_options_statistics_get_histogram(options: *mut DBOption,
                                                     hist_type: DBStatisticsHistogramType,
                                                     median: *mut c_double,
                                                     ...
                                                     -> bool;
    pub fn crocksdb_options_set_stats_dump_period_sec(options: *mut DBOption, v: usize);
    pub fn crocksdb_options_set_num_levels(options: *mut DBOption, v: c_int);
    pub fn crocksdb_options_set_db_log_dir(options: *mut DBOption, path: *const c_char);
    pub fn crocksdb_options_set_wal_dir(options: *mut DBOption, path: *const c_char);
    pub fn crocksdb_options_set_wal_ttl_seconds(options: *mut DBOption, ttl: u64);
    pub fn crocksdb_options_set_wal_size_limit_mb(options: *mut DBOption, limit: u64);
    pub fn crocksdb_options_set_use_direct_reads(options: *mut DBOption, v: bool);
    pub fn crocksdb_options_set_use_direct_io_for_flush_and_compaction(options: *mut DBOption,
                                                                       v: bool);
    pub fn crocksdb_options_set_prefix_extractor(options: *mut DBOption,
                                                 prefix_extractor: *mut DBSliceTransform);
    pub fn crocksdb_options_set_optimize_filters_for_hits(options: *mut DBOption, v: bool);
    pub fn crocksdb_options_set_level_compaction_dynamic_level_bytes(options: *mut DBOption,
                                                                     v: bool);
    pub fn crocksdb_options_set_memtable_insert_with_hint_prefix_extractor(options: *mut DBOption,
                                                 prefix_extractor: *mut DBSliceTransform);
    pub fn crocksdb_options_set_memtable_prefix_bloom_size_ratio(options: *mut DBOption,
                                                                 ratio: c_double);
    pub fn crocksdb_options_set_delayed_write_rate(options: *mut DBOption, rate: u64);
    pub fn crocksdb_options_set_ratelimiter(options: *mut DBOption, limiter: *mut DBRateLimiter);
    pub fn crocksdb_options_set_info_log(options: *mut DBOption, logger: *mut DBLogger);
    pub fn crocksdb_options_get_block_cache_usage(options: *const DBOption) -> usize;
    ...
    pub fn crocksdb_options_set_soft_pending_compaction_bytes_limit(options: *mut DBOption,
                                                                    v: u64);
    pub fn crocksdb_options_set_hard_pending_compaction_bytes_limit(options: *mut DBOption,
                                                                    v: u64);
    pub fn crocksdb_options_set_compaction_priority(options: *mut DBOption,
    ...
    pub fn crocksdb_open(options: *mut DBOption,
                         path: *const c_char,
                         err: *mut *mut c_char)
                         -> *mut DBInstance;
    ...
    pub fn crocksdb_destroy_db(options: *const DBOption,
                               path: *const c_char,
                               err: *mut *mut c_char);
    pub fn crocksdb_repair_db(options: *const DBOption,
                              path: *const c_char,
                              err: *mut *mut c_char);
    // Merge
    ...
    pub fn crocksdb_options_set_merge_operator(options: *mut DBOption, mo: *mut DBMergeOperator);
    // Iterator
    ...
    // Comparator
    pub fn crocksdb_options_set_comparator(options: *mut DBOption, cb: *mut DBComparator);
    ...
    pub fn crocksdb_list_column_families(db: *const DBOption,
                                         path: *const c_char,
                                         lencf: *mut size_t,
                                         err: *mut *mut c_char)
                                         -> *mut *mut c_char;
    ...
    pub fn crocksdb_backup_engine_open(options: *const DBOption,
                                       path: *const c_char,
                                       err: *mut *mut c_char)
                                       -> *mut DBBackupEngine;
    ...
    pub fn crocksdb_options_add_table_properties_collector_factory(
        options: *mut DBOption, f: *mut DBTablePropertiesCollectorFactory);
    ...
    pub fn crocksdb_options_add_eventlistener(opt: *mut DBOption, et: *mut DBEventListener);
